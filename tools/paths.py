# Site building script; some consent definitions.  -*- coding: utf-8 -*-
...
SRC_SUBDIR = 'src'
SRC_DATA_SUBDIR = _path.join(SRC_SUBDIR, 'data')
TPL_SUBDIR = _path.join(SRC_SUBDIR, 'tpl')
TMP_SUBDIR = '.tmp'
NO_EXPIRY_DIR_NAME = 'D'

REPO_URL = 'github.com/mina86/mina86.com'
